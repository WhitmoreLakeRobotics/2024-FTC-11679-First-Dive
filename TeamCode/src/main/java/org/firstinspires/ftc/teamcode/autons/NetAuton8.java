...
//@Disabled
@Autonomous(name = "NetAuton8", group = "Auton")
// @Autonomous(...) is the other common choice

public class NetAuton8 extends OpMode {
    ...
    public void loop() {
        ...
        switch (currentStage) {
            ...
            case _82_Forward1_2:
                if(robot.driveTrain.getCmdComplete()) {
                    robot.driveTrain.CmdDrive(27, 0, 0.60, -90);
            ...
            case _112_Scoring_Drive1_2:
                if (robot.driveTrain.getCmdComplete())  {
                    robot.driveTrain.CmdDrive(18,-145,0.60,-135);
                    runtime.reset();
            ...
            case _125_Drive_Out1:
                if (runtime.milliseconds() >= 300)  {
                    robot.driveTrain.CmdDrive(4,35,0.35,-135);
            ...
            case _140_Drive_Out1_2:
                if(robot.driveTrain.getCmdComplete()) {
                    robot.driveTrain.CmdDrive(18,35, 0.60, -135);
            ...
            case _150_Drive_Out1_3:
                if(robot.driveTrain.getCmdComplete()) {
                    robot.driveTrain.CmdDrive(4, 35, 0.35, -90); //was 4 distance;
            ...
            case _270_Drive_Out3_3:
                if (robot.driveTrain.getCmdComplete())     {
                    robot.driveTrain.CmdDrive(4,35,0.35,-90);
            ...
            case _315_Turn3:
                if(robot.arm.getCmdComplete()){
                    robot.driveTrain.cmdTurn(-145,0.35);
