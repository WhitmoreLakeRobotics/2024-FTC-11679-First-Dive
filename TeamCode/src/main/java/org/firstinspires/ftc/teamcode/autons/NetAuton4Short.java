...
@Disabled
@Autonomous(name = "NetAuton4Short", group = "Auton")
// @Autonomous(...) is the other common choice

public class NetAuton4Short extends OpMode {
        ...
        switch (currentStage) {
            ...
            case _130_Forward:
                if (robot.driveTrain.getCmdComplete()){
                    ...
                    currentStage = stage._140_Drive_Right;}
                break;


            case _140_Drive_Right:
                if (robot.driveTrain.getCmdComplete()){
                    robot.driveTrain.CmdDrive(116,90,0.35,0);
                    currentStage = stage._150_Reverse;}
                break;
